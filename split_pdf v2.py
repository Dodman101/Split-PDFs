...
def extract_and_rename_files(input_path, output_dir):
...
def split_pdf():
    ...
    # Select input file
    print("Select the input PDF file to split.")
    input_path = select_input_file()
    if input_path is None:
        return

    # Select output directory
    print("Select the output directory to save the split PDF files.")
    output_dir = select_output_directory()
    if output_dir is None:
        return

    # Extract and rename files
    extract_and_rename_files(input_path, output_dir)
